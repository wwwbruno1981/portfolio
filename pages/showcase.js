...
function Showcase() {
    return (
      ...
      <div className="relative bg-white overflow-hidden">
        ...
        <div className="relative pt-6 px-4 sm:px-6 lg:px-8 z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">

        <div className="lg:absolute lg:inset-y-0 lg:left-0">
  <img
     className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full"
     src="/assets/bgROU.png"
     alt=""
     width={1000} 
     height={1000}
    /> 
...
<svg
 ...
 {/*Images in grid */}
          <div>
            <div className="mt-10">
              <div className="lg:absolute lg:inset-y-0 lg:right-2/4 bg-gray-100">
              <div
                aria-hidden="true"
